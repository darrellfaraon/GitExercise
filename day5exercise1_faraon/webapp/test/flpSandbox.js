		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpday5exercise1faraon-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise1faraon-display": {
								"semanticObject": "zbtpday5exercise1faraon",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise1faraon",
									"url": sap.ui.require.toUrl("zbtp/day5exercise1faraon")
								}
							}
						}
					}
