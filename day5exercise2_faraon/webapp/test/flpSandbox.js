		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fragment and Internationalization Exercise",
									"targetURL": "#zbtpday5exercise2faraon-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise2faraon-display": {
								"semanticObject": "zbtpday5exercise2faraon",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise2faraon",
									"url": sap.ui.require.toUrl("zbtp/day5exercise2faraon")
								}
							}
						}
					}
